        ...
        <div className="row">
            <div className="column">
                <div className="ui vertical segment">
                    ...
                    <br /><br />
                    Before moving to Japan I worked
                    at <a href="https://www.itri.org.tw/english/" target="_blank" rel="noopener noreferrer">ITRI</a> in Hsinchu, Taiwan
                    and <a href="https://www.gist.ac.kr/en/main.html" target="_blank" rel="noopener noreferrer">GIST</a> in Gwangju, South Korea as an intern during college summer vacations.
                    <br /><br />
