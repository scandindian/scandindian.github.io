        ...
        <div className="row">
            <div className="column">
                <div className="ui vertical segment">
                    ...
                    <br /><br />
                    Before moving to Japan I have worked
                    at <a href="https://www.itri.org.tw/english/" target="_blank" rel="noopener noreferrer">ITRI</a> in Hsinchu, Taiwan
                    and <a href="https://www.gist.ac.kr/en/main.html" target="_blank" rel="noopener noreferrer">GIST</a> in Gwangju, South Korea as an intern during college.
                    <br /><br />
                    My current passion is working with ReactJS and Redux for the frontend. For the backend, I use the Django REST framework and AWS.
                    ...
                    <br /><br />
                    In the future, I would like to keep working as a frontend developer. I love developing beautiful and scalable web apps with a focus on user experience.
                    <br /><br />
                    Feel free to <Link to="/contact">connect</Link> with me or see me <a id="resume-button" href="/Resume.pdf" target="_blank" rel="noopener noreferrer">résumé</a>. I am looking forward to hearing from you.
                    </p>
                </div>
            </div>
        </div>
